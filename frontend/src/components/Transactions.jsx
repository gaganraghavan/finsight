...
import { Plus, Edit2, Trash2, DollarSign, Calendar, Tag, FileText, TrendingUp, TrendingDown, Search, Filter } from "lucide-react";
  ...
  return (
    <section className="max-w-7xl mx-auto p-6 space-y-8 animate-slide-up">
      ...
      <div className="card-gradient">
        <div className="overflow-x-auto rounded-xl border-2 border-slate-200/60 dark:border-slate-800/60">
          <table className="w-full text-sm">
            ...
            <tbody className="bg-white/60 dark:bg-slate-900/60">
              {filteredItems.map((t, idx) => (
                <tr key={t._id} className="table-row group" style={{ animationDelay: `${idx * 30}ms` }}>
